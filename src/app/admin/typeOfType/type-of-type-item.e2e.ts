...
import { TypeOfTypeItemPageObject } from './type-of-type-item.po';
import { TypeOfType } from '../services/api/models/type-of-type';
import { ValidationService } from '../common/services/validation.service';
import { E2eHelper } from '../common/e2eHelper';
import * as changeCase from 'change-case';

describe('Type Of Type Item', () => {
  describe('As a user, I', () => {
    let helper = new E2eHelper();
    let adminView = new AdminView();
    let listPO = new TypeOfTypeListPageObject();
    let itemPO = new TypeOfTypeItemPageObject();
    let listWithCount = require('../services/api/local/TypeOfType.json');
