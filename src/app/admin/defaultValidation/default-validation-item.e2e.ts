...
import { DefaultValidationItemPageObject } from './default-validation-item.po';
...
describe('Default Validation Item', () => {
  describe('As a user, I', () => {
    let helper = new E2eHelper();
    let adminView = new AdminView();
    let listPO = new DefaultValidationListPageObject();
    let itemPO = new DefaultValidationItemPageObject();
    let listWithCount = require('../services/api/local/DefaultValidation.json');
