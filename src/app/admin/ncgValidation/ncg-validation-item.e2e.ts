...
import { NcgValidationListPageObject } from './ncg-validation-list.po';
import { NcgValidationItemPageObject } from './ncg-validation-item.po';
...
describe('Ncg Validation Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new NcgValidationListPageObject();
    let itemPO = new NcgValidationItemPageObject();
    let listWithCount = require('../services/api/local/NcgValidation.json');
