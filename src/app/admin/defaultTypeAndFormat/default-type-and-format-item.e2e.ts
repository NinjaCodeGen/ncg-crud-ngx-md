...
import { DefaultTypeAndFormatListPageObject } from './default-type-and-format-list.po';
import { DefaultTypeAndFormatItemPageObject } from './default-type-and-format-item.po';
...
describe('Default Type And Format Item', () => {
  describe('As a user, I', () => {
    ...
    let listPO = new DefaultTypeAndFormatListPageObject();
    let itemPO = new DefaultTypeAndFormatItemPageObject();
    let listWithCount = require('../services/api/local/DefaultTypeAndFormat.json');
